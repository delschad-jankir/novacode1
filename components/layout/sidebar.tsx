...
const baseProjectNavItems = [
  ...
  },
  {
    ...
    slug: 'general', // Added slug for dynamic routing
    icon: "BadgeInfo",
    label: 'General Information'
  },
  {
    title: 'Code Structure',
    slug: 'code-structure', // Added slug for dynamic routing
    icon: "Code",
    label: 'Code Structure'
  },
  {
    title: 'Components and Modules',
    slug: 'components', // Added slug for dynamic routing
    icon: "Box",
    label: 'Components and Modules'
  },
  {
    title: 'Code Styles and Practices',
    slug: 'code-styles', // Added slug for dynamic routing
    icon: "Brush",
    label: 'Code Styles and Practices'
  },
  {
    title: 'Build and Dev Process',
    slug: 'build-process', // Added slug for dynamic routing
    icon: "Wrench",
    label: 'Build and Dev Process'
  },
  {
    title: 'Q&A',
    slug: 'qa', // Added slug for dynamic routing
    icon: "HelpCircle",
    label: 'Q&A'
  }
];
